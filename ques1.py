...
# Join on country_id to get only Canadian addresses
result = pd.merge(locations, countries[countries['country_name'] == "Canada"], on="country_id", how="inner")
result = result[["location_id", "street_address", "city", "state_province", "country_name"]]
print(result)